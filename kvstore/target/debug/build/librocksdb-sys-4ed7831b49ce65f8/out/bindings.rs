...
extern "C" {
    ...
    #[doc = " *id_len. Returns NULL if an error occurred."]
...
pub const rocksdb_size_approximation_flags_none: libc::c_uint = 0;
pub const rocksdb_size_approximation_flags_include_memtable: libc::c_uint = 1;
pub const rocksdb_size_approximation_flags_include_files: libc::c_uint = 2;
...
pub const rocksdb_block_based_k_fallback_pinning_tier: libc::c_uint = 0;
pub const rocksdb_block_based_k_none_pinning_tier: libc::c_uint = 1;
pub const rocksdb_block_based_k_flush_and_similar_pinning_tier: libc::c_uint = 2;
pub const rocksdb_block_based_k_all_pinning_tier: libc::c_uint = 3;
...
pub const rocksdb_statistics_level_disable_all: libc::c_uint = 0;
pub const rocksdb_statistics_level_except_tickers: libc::c_uint = 0;
pub const rocksdb_statistics_level_except_histogram_or_timers: libc::c_uint = 1;
pub const rocksdb_statistics_level_except_timers: libc::c_uint = 2;
pub const rocksdb_statistics_level_except_detailed_timers: libc::c_uint = 3;
pub const rocksdb_statistics_level_except_time_for_mutex: libc::c_uint = 4;
pub const rocksdb_statistics_level_all: libc::c_uint = 5;
...
pub const rocksdb_prepopulate_blob_disable: libc::c_uint = 0;
pub const rocksdb_prepopulate_blob_flush_only: libc::c_uint = 1;
...
pub const rocksdb_k_by_compensated_size_compaction_pri: libc::c_uint = 0;
pub const rocksdb_k_oldest_largest_seq_first_compaction_pri: libc::c_uint = 1;
pub const rocksdb_k_oldest_smallest_seq_first_compaction_pri: libc::c_uint = 2;
pub const rocksdb_k_min_overlapping_ratio_compaction_pri: libc::c_uint = 3;
pub const rocksdb_k_round_robin_compaction_pri: libc::c_uint = 4;
...
pub const rocksdb_number_async_seek: libc::c_uint = 68;
pub const rocksdb_blob_cache_hit_count: libc::c_uint = 69;
pub const rocksdb_blob_read_count: libc::c_uint = 70;
pub const rocksdb_blob_read_byte: libc::c_uint = 71;
pub const rocksdb_blob_read_time: libc::c_uint = 72;
pub const rocksdb_blob_checksum_time: libc::c_uint = 73;
pub const rocksdb_blob_decompress_time: libc::c_uint = 74;
pub const rocksdb_internal_range_del_reseek_count: libc::c_uint = 75;
pub const rocksdb_block_read_cpu_time: libc::c_uint = 76;
pub const rocksdb_total_metric_count: libc::c_uint = 79;
...
extern "C" {
    ...
    #[doc = " column family."]
    #[doc = ""]
    #[doc = " Note that the caller is responsible to release the returned memory"]
    #[doc = " using rocksdb_column_family_metadata_destroy."]
...
extern "C" {
    ...
    #[doc = " column family metadata."]
    #[doc = ""]
    #[doc = " If the specified i is greater than or equal to the number of levels"]
    #[doc = " in the specified column family, then NULL will be returned."]
    #[doc = ""]
    #[doc = " Note that the caller is responsible to release the returned memory"]
    #[doc = " using rocksdb_level_metadata_destroy before releasing its parent"]
    #[doc = " rocksdb_column_family_metadata_t."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Note that the specified rocksdb_level_metadata_t must be released"]
    #[doc = " before the release of its parent rocksdb_column_family_metadata_t."]
...
extern "C" {
    ...
    #[doc = " metadata."]
    #[doc = ""]
    #[doc = " If the specified i is greater than or equal to the number of files"]
    #[doc = " in the specified level, then NULL will be returned."]
    #[doc = ""]
    #[doc = " Note that the caller is responsible to release the returned memory"]
    #[doc = " using rocksdb_sst_file_metadata_destroy before releasing its"]
    #[doc = " parent rocksdb_level_metadata_t."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Note that the specified rocksdb_sst_file_metadata_t must be released"]
    #[doc = " before the release of its parent rocksdb_level_metadata_t."]
...
extern "C" {
    ...
    #[doc = " The caller is responsible for releasing the returned memory."]
    #[doc = ""]
    #[doc = " @param file_meta the metadata of an SST file to obtain its smallest key."]
    #[doc = " @param len the out value which will contain the length of the returned key"]
    #[doc = "     after the function call."]
